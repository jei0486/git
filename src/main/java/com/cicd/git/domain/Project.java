...
import com.cicd.git.domain.model.*;
import com.cicd.git.domain.model.ImportStatus.Status;
import com.cicd.git.domain.model.Constants.AutoDevopsDeployStrategy;
import com.cicd.git.domain.model.Constants.BuildGitStrategy;
import com.cicd.git.domain.model.Constants.SquashOption;
import com.cicd.git.util.JacksonJson;
import com.cicd.git.util.JacksonJsonEnumHelper;
